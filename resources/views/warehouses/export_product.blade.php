...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="card solution_cards_box">
          <div class="card-body solution_card">
            ...
            <div class="media">
              ...
              <div class="media-body">
                <p class="card-text">Quản lý các tác vụ liên quan đến nhập sản phẩm vào kho hàng.</p>
                <p class="card-text"><i class="ti-arrow-circle-right"></i><a class="a_custom" href="{{Route("admin.warehouse.import_product")}}"> Đến trang quản lý</a></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-12 grid-margin stretch-card form_default">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Danh sách hoạt động xuất hàng</h4>
