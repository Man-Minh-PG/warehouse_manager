  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="{{asset("../asset_admin/images/logo.svg")}}" class="mr-2" alt="logo"/></a>
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="{{asset("../asset_admin/images/faces/face1.jpg")}}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Thomas Douglas</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="{{asset("../asset_admin/images/faces/face2.jpg")}}" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{asset("../asset_admin/images/faces/face3.jpg")}}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Daniel Russell</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="{{asset("../asset_admin/images/faces/face4.jpg")}}" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{asset("../asset_admin/images/faces/face5.jpg")}}" alt="image"><span class="online"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{asset("../asset_admin/images/faces/face6.jpg")}}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Sarah Graves</p>
                  <p>Available</p>
                </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item item1">
            <a class="nav-link" href="{{Route("admin.home")}}">
              ...
              <span class="menu-title title1">Thống kê</span>
            </a>
          </li> 
          <li class="nav-item item2">
            <a class="nav-link" href="{{Route("admin.unit")}}">
              <i class="icon-box menu-icon"></i>
              <span class="menu-title title2">Quản lý đơn vị</span>
            </a>
          </li>
          <li class="nav-item item3">
            <a class="nav-link" href="{{Route("admin.product_type")}}">
              <i class="icon-layers menu-icon"></i>
              <span class="menu-title title3">Quản lý loại sản phẩm</span>
            </a>
          </li>
          <li class="nav-item item4">
            <a class="nav-link" href="{{Route("admin.product")}}">
              <i class="icon-briefcase menu-icon"></i>
              <span class="menu-title title4">Quản lý sản phẩm</span>
            </a>
          </li>
          <li class="nav-item item5">
            <a class="nav-link" href="{{Route("admin.warehouse")}}">
              <i class="icon-cloud menu-icon"></i>
              <span class="menu-title title5">Quản lý kho</span>
            </a>
          </li>
          <li class="nav-item item6">
            <a class="nav-link" href="{{Route("admin.history")}}">
              <i class="icon-clock menu-icon"></i>
              <span class="menu-title title6">Lịch xử thao tác</span>
            </a>
          </li>
          <li class="nav-item item7">
            <a class="nav-link" href="#">
              <i class="icon-help menu-icon"></i>
              <span class="menu-title title7">Đăng Xuất</span>
            </a>
          </li>
        </ul>
      </nav>
